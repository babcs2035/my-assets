...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    nameKey?: string;
    labelKey?: string;
    // biome-ignore lint/suspicious/noExplicitAny: need to handle unclear recharts types
    payload?: any[];
    active?: boolean;
    // biome-ignore lint/suspicious/noExplicitAny: need to handle unclear recharts types
    label?: any;
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-2 rounded-lg border border-border/50 bg-background px-3 py-2 text-sm shadow-xl",
          className,
        )}
      >
...
const ChartLegendContent = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    hideIcon?: boolean;
    nameKey?: string;
    // biome-ignore lint/suspicious/noExplicitAny: need to handle unclear recharts payload type
    payload?: any[];
  }
>(
  (
